...
# En Docker el front va tras nginx (mismo origen) → CORS sólo importa para el
# dev directo. Configurable con BES_CORS_ORIGINS (lista separada por comas).
...
_cors_origins = [
    o.strip()
    for o in os.environ.get("BES_CORS_ORIGINS", _DEFAULT_CORS_ORIGINS).split(",")
    if o.strip()
]
